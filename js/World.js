/* -------- World.js ----------*/
function World(rowsIn, columnsIn, speedIn) {
	this.rows = rowsIn;
	...
	this.rowsSPAN = document.getElementById('rowsElement');
	this.columnsSPAN = document.getElementById('columnsElement');
	this.speedSPAN = document.getElementById('speedElement');
	this.generationCurrentSPAN = document.getElementById('generationCurrentElement');
...
/* ---------------------------------------------------------------------------------- */
World.prototype.updateHeader = function() {

	this.generationCurrentSPAN.innerHTML = this.generationCurrent;
	this.rowsSPAN.innerHTML = this.rows;
	this.columnsSPAN.innerHTML = this.columns;
	this.speedSPAN.innerHTML = this.speed;
