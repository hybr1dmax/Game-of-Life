...
function showBlock(which) {
	...
	var worldField = document.getElementById('worldField');
	var inputForm = document.getElementById('inputForm');

	if(which == 'world') {
		inputForm.style.display = 'none';
		worldField.style.display = 'table-cell';
	}
	if(which == 'form') {
		worldField.style.display = 'none';
		inputForm.style.display = 'table-cell';
	}
}
/* ---------------------------------------------------------------------------------- */
